...
@Repository
public interface AsimaZhorabayevaUserRepository
        extends JpaRepository<AsimaZhorabayevaUser, Long> {

    Optional<AsimaZhorabayevaUser> findByUsername(String username);
